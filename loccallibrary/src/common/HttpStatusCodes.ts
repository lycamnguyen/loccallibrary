...
enum HttpStatusCodes {
   ...
   * Sending a large request body to a server
   * after a request has been rejected for inappropriate headers would be inefficient.
  ...
  /**
   * The members of a DAV binding have already been enumerated in
   * a preceding part of the (multistatus) response,
